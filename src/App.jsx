...
const App = () => {
  ...
  const [recon] = useState(new (window.webkitSpeechRecognition)())
  const [speaker] = useState(window.speechSynthesis)
  const [utterThis] = useState(new SpeechSynthesisUtterance())
